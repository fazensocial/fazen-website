        ...
        <PageHero
          ...
          headline={
            <>
              ...
              <span className="text-fazen">No hidden catch.</span>
            </>
          }
          description="Clear, flexible pricing for every stage of your brand — from solo founders to growing teams. Pick your plan, start creating."
          primaryButton={
            <Link
              href="#pricing-detail"
