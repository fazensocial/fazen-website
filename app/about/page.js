      ...
      <main className="flex-1">
        ...
        <PageHero
          ...
          headline={
            <>
              The designer<br />
              <span className="text-fazen">behind the brand.</span>
            </>
          }
          description="Hafaz Sofyan — graphic designer and creativepreneur with 5+ years building brands that mean something. Creative, adaptable, and always pushing the work further."
          primaryButton={
            <Link
              href="/portfolio"
